...
<body>
    ...
    <form action="edit" method="post">
        ...
        <input type="text" id="uname" name="uname" class="form-control" value="${user.getUsername()}" onkeyup="validation()">
        <span id="unameErr" class="text-danger"></span>
         </div>

         <div class="form-group">
        <label for="email">Email</label>
        <input type="text" id="email" name="email" class="form-control" value="${user.getEmail()}" onkeyup="validation()">
